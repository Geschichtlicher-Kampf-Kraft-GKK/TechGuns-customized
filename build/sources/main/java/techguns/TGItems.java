...
public class TGItems implements ITGInitializer{
	...
	//TOOL Materials
	static ToolMaterial TG_STEEL = EnumHelper.addToolMaterial("Steel", 2, 1000, 7.5f, 5f, 12);
	static ToolMaterial TG_TITAN = EnumHelper.addToolMaterial("Titanium", 4, 5000, 7.5f, 9f, 12);
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		COMBAT_KNIFE = new TGSword(TG_TITAN, "combatknife");
