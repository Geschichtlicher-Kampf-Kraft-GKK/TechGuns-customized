...
import scala.actors.migration.OutputChannelRef;
...
public class TGEntities implements ITGInitializer {
	...
	public void init(FMLInitializationEvent event) {
		...
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(ZombieSoldier.class, TGConfig.spawnWeightZombieSoldier), 0);
		...
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(SkeletonSoldier.class, TGConfig.spawnWeightSkeletonSoldier), 0);
		
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(Bandit.class, TGConfig.spawnWeightBandit), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(ArmySoldier.class, TGConfig.spawnWeightArmySoldier), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(CyberDemon.class, TGConfig.spawnWeightCyberDemon), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(PsychoSteve.class, TGConfig.spawnWeightPsychoSteve), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(Commando.class, TGConfig.spawnWeightCommando), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(StormTrooper.class, TGConfig.spawnWeightStormTrooper), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(Outcast.class, TGConfig.spawnWeightOutcast), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(DictatorDave.class, TGConfig.spawnWeightDictatorDave), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(AttackHelicopter.class, TGConfig.spawnWeightAttackHelicopter, true), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(SuperMutantBasic.class, TGConfig.spawnWeightSuperMutantBasic), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(SuperMutantElite.class, TGConfig.spawnWeightSuperMutantElite), 0);
		TGSpawnManager.spawnTableOverworld.registerSpawn(new TGNpcSpawn(SuperMutantHeavy.class, TGConfig.spawnWeightSuperMutantHeavy), 0);

		TGSpawnManager.spawnTableNether.registerSpawn(new TGNpcSpawn(SuperMutantElite.class, 7000), 0);
		TGSpawnManager.spawnTableNether.registerSpawn(new TGNpcSpawn(SuperMutantHeavy.class, 3000), 0);
