...
public class TGNpcSpawn {
	...
	protected boolean ifFly = false;
	protected Class<? extends GenericNPC> type;
	protected Class<? extends GenericFlyingMob> fly;
	...
	public TGNpcSpawn(Class<? extends GenericFlyingMob> type, int spawnWeight, boolean ifFly){
		this.ifFly = ifFly;
		this.fly=type;
		this.spawnWeight=spawnWeight;
		this.biomeWhitelist = null;
